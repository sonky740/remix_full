      ...
      <div className="flex items-center gap-4">
        ...
        <div className="space-y-5">
          <div className="flex gap-2">
            <h1 className="text-2xl font-semibold">Sonky</h1>
            ...
            <Dialog>
              ...
              <DialogContent>
                ...
                <DialogDescription className="space-y-4">
                  <span className="text-sm text-muted-foreground">Send a message to Sonky</span>
          ...
          <div className="flex gap-2 items-center">
            <span className="text-sm text-muted-foreground">@sonky740</span>
