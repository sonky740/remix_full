...
export default function CategoryPage() {
  ...
  const categoryInfo = {
    software: {
      name: '소프트웨어',
      icon: '💻',
      description: '다양한 소프트웨어 제품들을 확인하세요.',
    },
    hardware: {
      name: '하드웨어',
      icon: '🖥️',
      description: '최신 하드웨어 제품들을 확인하세요.',
    },
    services: {
      name: '서비스',
      icon: '🔧',
      description: '유용한 서비스 제품들을 확인하세요.',
    },
    mobile: {
      name: '모바일',
      icon: '📱',
      description: '모바일 관련 제품들을 확인하세요.',
    },
    ai: {
      name: '인공지능',
      icon: '🤖',
      description: '혁신적인 인공지능 제품들을 확인하세요.',
    },
    iot: {
      name: '사물인터넷',
      icon: '🌐',
      description: '연결된 사물인터넷 제품들을 확인하세요.',
    },
    gaming: {
      name: '게임',
      icon: '🎮',
      description: '재미있는 게임 제품들을 확인하세요.',
    },
    productivity: {
      name: '생산성',
      icon: '📊',
      description: '효율적인 생산성 제품들을 확인하세요.',
    },
    education: {
      name: '교육',
      icon: '📚',
      description: '유익한 교육 제품들을 확인하세요.',
    },
    health: {
      name: '건강',
      icon: '🏥',
      description: '건강 관련 제품들을 확인하세요.',
    },
    finance: {
      name: '금융',
      icon: '💰',
      description: '금융 관련 제품들을 확인하세요.',
    },
    entertainment: {
      name: '엔터테인먼트',
      icon: '🎬',
      description: '즐거운 엔터테인먼트 제품들을 확인하세요.',
    },
  };
