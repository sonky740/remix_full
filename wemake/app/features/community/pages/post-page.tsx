...
import { BreadcrumbNavigation } from '~/common/components/breadcrumb-navigation';
...
export default function PostPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Productivity', href: '/community?topic=productivity' },
    { label: 'What is the best productivity tool?', href: `/community/${postId}` },
  ];
